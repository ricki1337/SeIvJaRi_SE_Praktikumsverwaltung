...
public class StudentSingleNew extends ControllerNew implements EditBoxCtrl, NaviAbortSaveBoxCtrl, NaviPrevSaveNextBoxCtrl{
	...
	public StudentSingleNew(Object primaryKeys){
		super();
	...
	public void setElementsForNewData() {
		view.addComponentToView(new BoxElementStudentDetailsNew(this));
		BoxElementBottomNavi navi = new BoxElementBottomNavi(this);
